...
namespace TB_QuestGame
{
    ...
    public class ConsoleView
    {
        ...
        public Hero GetInitialHeroInfo()
        {
            ...
            // get hero's name
            //
            DisplayGamePlayScreen("Hero Creation - Name", Text.InitializeMissionGetTravelerName(), ActionMenu.MissionIntro, "");
            ...
            // get hero's race
            //
            DisplayGamePlayScreen("Hero Creation - Class", Text.InitializeMissionGetTravelerRace(hero), ActionMenu.MissionIntro, "");
